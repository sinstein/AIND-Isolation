...
def custom_score(game, player):
    ...
    return float(math.hypot(p2x - p1x, p2y - p1y))
...
def custom_score_2(game, player):
    ...
    return float(2 * len(moves) - len(opponent_moves) + len(list(set(moves) & set(opponent_moves))))
...
def custom_score_3(game, player):
    ...
    moves = game.get_legal_moves(player)
    opponent_moves = game.get_legal_moves(game.get_opponent(player))
    return float(len(moves) + len(list(set(moves) & set(opponent_moves))))
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        for m in game.get_legal_moves():
            move_score = self.min_value(game.forecast_move(m), depth)
